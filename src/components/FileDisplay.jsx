...
export default function FileDisplay(props){
    ...
    const audioRef = useRef(null) //to pasas reference to the audio element (move to that DOM elem)
    ...
    return(
        <div>
            ...
            <h1 className='font-semibold text-3xl sm:text-4xl md:text-5xl'>Your <nbsp></nbsp>file </h1>
